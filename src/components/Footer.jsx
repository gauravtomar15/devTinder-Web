    ...
    <footer className="footer footer-center sm:footer-horizontal bg-neutral text-neutral-content items-center p-3 sm:p-4 mt-auto">
      <aside className="grid-flow-col items-center gap-2 sm:gap-4">
        <svg
          ...
          fillRule="evenodd"
          clipRule="evenodd"
          className="fill-current w-6 h-6 sm:w-8 sm:h-8 md:w-9 md:h-9"
        >
        ...
        <p className="text-xs sm:text-sm md:text-base">Copyright © {new Date().getFullYear()} - All right reserved</p>
        <p className="text-xs sm:text-sm md:text-base">Developed by- Gaurav Tomar ❤️</p>
